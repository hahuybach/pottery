    ...
    <>
      <div className="row margin">
        <div className="col-md-5 px-5 d-flex align-items-center">
          <div>
            ...
            <p className="label-2 pe-5">
              Bình hoa hay lọ hoa là một vật dụng trang trí giúp căn nhà của
              chúng ta trông lộng lẫy và sang trọng hơn. Hiện nay có rất nhiều
              loại bình với thiết kế đẹp, bắt mắt nhưng bình hoa làm từ gốm sứ
              vẫn thân thuộc và đa dạng phong cách hơn.
            </p>
        ...
        <div className="col-md-7">
          <img className={homeStyle.homeIntroImg} src={vaseImage} alt="" />
        </div>
